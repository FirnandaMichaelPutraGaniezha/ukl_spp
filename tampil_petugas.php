...
<style>
  ...
  <tbody>
      ...
      if (isset($_POST["cari"])) {
          ...
          $cari = $_POST['cari'];
          $qry_petugas = mysqli_query($koneksi, "select * from petugas where id_petugas='$cari' or nama_petugas like'%$cari%'");
      } else {
      ...
      ?>
        <tr>
            ...
            <td>
            <a href="ubah_petugas.php?id_petugas=<?=$data_petugas['id_petugas']?>" class="btn btn-success">Update</a>

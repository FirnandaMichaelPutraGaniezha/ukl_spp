...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="home.php">PEMBAYARAN SPP</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="tampil_petugas.php">Data Petugas</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="tampil_spp.php">Spp</a>
                    </li>
                    <li class="nav-item">

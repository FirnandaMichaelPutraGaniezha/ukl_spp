...
if($_POST){
    ...
    if(empty($nama_petugas)){
        ...
        include "koneksi.php";
        $update=mysqli_query($koneksi,"update petugas set nama_petugas='".$nama_petugas."', username='".$username."', password='".md5($password)."' where id_petugas = '".$id_petugas."'") or die(mysqli_error($koneksi));
        if($update){

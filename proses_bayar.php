...
if($_POST){
    ...
    $id_spp = $_POST['id_spp'];
        ...
        $cek = mysqli_query($koneksi,"SELECT * from pembayaran where nisn ='".$nisn."' and bulan_spp = '".$bulan_spp."' and tahun_spp = '".$tahun_spp."'");
        if(mysqli_num_rows($cek) > 0  ){
            echo "<script>alert('Pembayaran Sudah Ada'); location.href='history_pembayaran.php';</script>";
